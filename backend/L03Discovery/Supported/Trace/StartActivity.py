...
class StartActivity(DiscoveryStepSuperClass):

	def __init__(self):

		super().__init__("Start Activity","Specify end activities a trace must end on to be considered for discovery.",
	...
	def create_attribute_parameter(self):
		parameter = ParameterSelection("Activities","Select start activities.")
		return parameter
