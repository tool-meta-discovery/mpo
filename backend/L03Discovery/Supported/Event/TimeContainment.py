...
class TimeContainment(DiscoveryStepSuperClass):
	...
	def __init__(self):
		...
		super().__init__("Time Frame Selection Filter",
						"You can use this filter to only include events that fall into the" 
						"specified time interval. All other events will be discarded for the"
	...
	def create_lower_bound_parameter(self):
		parameter = ParameterTime("Lower Time Bound",
											...
											"time interval filtering. All events occuring before this date time will be"
											"discarded for the optimization process.")
	...
	def create_upper_bound_parameter(self):
		parameter = ParameterTime("Upper Time Bound",
											...
											"time interval filtering. All events occuring after this date time will be"
											"discarded for the optimization process.")
